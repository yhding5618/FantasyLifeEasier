...
这个功能会在完成一次“连续操作”之后自动选择“再次制作”，再进行下一次“连续操作”，无限循环，中止循环需要手动按F5重新打开脚本或按F4直接关闭脚本。这里有两种用法供参考：

1. 素材不多的时候进行多次数量为一的制作，这样每次超大成功的制作都可以获得四份产物。
1. 挂机刷随性制作，可以配合“自动截图”，脚本会在每次制作结果出现时（按F12）截图，方便查看记录。
